...
<html>
	<head>
       ...
       <!-- FIN archivos para DATA TABLES-->
		...
		function ver(idcontrato) {
			parent.location.href="ver.php?idcontrato=" + idcontrato;
		}
		
		function modificar(idcontrato) {
                    
			parent.location.href="modificar.php?idcontrato=" + idcontrato;
		}
		
		function eliminar(idcontrato) {
                    if (confirm("Atencion va a proceder a la baja de una entidad bancaria. Desea continuar?")) {
			parent.location.href="eliminar.php?idcontrato=" + idcontrato;
                    }
		}
