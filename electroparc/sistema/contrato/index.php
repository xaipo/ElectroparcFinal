	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">contratoS</div>
				<div id="frmBusqueda">
                                    <form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">                                
                                        <br/>
                                        <img src="../img/icono_nuevo.jpg" title="nuevo" border="0" width="30" height="30" border="1" onClick="nuevo_contrato()" onMouseOver="style.cursor=cursor">
                                </div>
                                     </form>
